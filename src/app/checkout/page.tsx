                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="firstname">
                    <label className="mb-2 block text-xs font-semibold text-slate-600">
                      FIrst Name<span className="text-danger-500 opacity-75 ml-1">*</span>
                    </label>
                  ...
                  <div className="lastname">
                    <label className="mb-2 block text-xs font-semibold text-slate-600">
                      Last Name<span className="text-danger-500 opacity-75 ml-1">*</span>
                    </label>
                  ...
                  <div className="phone">
                    <label className="mb-2 block text-xs font-semibold text-slate-600">
                      Phone<span className="text-danger-500 opacity-75 ml-1">*</span>
                    </label>
                  ...
                  <div className="email">
                    <label className="mb-2 block text-xs font-semibold text-slate-600">
                      Email<span className="text-danger-500 opacity-75 ml-1">*</span>
                    </label>
                    <div className="relative">
                      <input
                        className="w-full rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30"
                  ...
                  <div className="city">
                    <label className="mb-2 block text-xs font-semibold text-slate-600">
                      City<span className="text-danger-500 opacity-75 ml-1">*</span>
                    </label>
                    <div className="relative">
                      <input
                        className="w-full rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30"
                  ...
                  <div className="country">
                    <label className="mb-2 block text-xs font-semibold text-slate-600">
                      Country<span className="text-danger-500 opacity-75 ml-1">*</span>
                    </label>
                    <div className="relative">
                      <input
                        className="w-full rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30"
