...
import QdrantProductsCarousel from "../components/QdrantProductsCarousel";
...
export default async function Page({
  ...
  return (
    <>
      ...
      <div className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 3xl:px-[300px] relative">
        <div className=" flex flex-col lg:flex-row lg:items-start gap-8 mt-8 lg:mt-12">
        ...
        <div className="qdrant-prod-carousel mt-16">
          <Suspense fallback={"Loading..."}>
            <QdrantProductsCarousel
              productId={product._id!}
              carouselTitle="Semantic Related Products"
              limit={12}
            />
          </Suspense>
        </div>
